...
VERTICALS = {
    ...
    "veterinarians": {
        ...
        "lede": 'When a new pet owner needs a vet — or a scared one needs an emergency clinic now — they search "vet near me" and call the top of the map. I get veterinary practices into those spots and keep them there. Start with a free, specific audit. No pitch attached.',
        ...
        "sample": {
            "name": "Cedar Creek Animal Hospital", "sub": "Small-animal veterinary clinic",
        ...
        "how_keywords": "client-intent keywords",
        "rank_keyword_phrase": "top client keywords",
        "longtail_phrase": "service long-tails",
        "human_review_note": "",
        ...
        "service_desc": "Local search marketing for veterinarians: Google map pack ranking for 'vet near me' and emergency searches, review velocity programs, Google Business Profile content, and citation cleanup.",
    },
    ...
    "salons": {
        ...
        "lede": 'New clients find a salon by searching "hair salon near me" or "balayage [city]" and booking from the top of the map — chosen on photos and reviews. I get salons into those spots and keep them there. Start with a free, specific audit. No pitch attached.',
        ...
        "sample": {
            "name": "Wildflower Hair Studio", "sub": "Hair salon &amp; color studio",
        ...
        "service_desc": "Local search marketing for hair salons: Google map pack ranking for 'salon near me' and service searches, review and photo velocity, Google Business Profile content, and citation cleanup.",
    },
    ...
    "auto-repair": {
        ...
        "lede": 'When a car needs work, people search "mechanic near me" or "brake repair [city]" and call one of the top three on the map — chosen on reviews and trust. I get auto repair shops into those spots and keep them there. Start with a free, specific audit. No pitch attached.',
        ...
        "sample": {
            "name": "Granite City Auto &amp; Tire", "sub": "Independent auto repair shop",
            "stats": [("Google Rating", "4.5★", "warn"), ("Reviews", "52", "warn"), ('Rank for "auto repair"', "#7", "bad")],
        ...
        "service_desc": "Local search marketing for auto repair shops: Google map pack ranking for 'mechanic near me' and repair searches, review velocity programs, Google Business Profile content, and citation cleanup.",
    },
}
